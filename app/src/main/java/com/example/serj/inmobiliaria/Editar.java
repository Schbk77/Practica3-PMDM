...
public class Editar extends Activity {
    ...
    public void guardarCambios(View view){
        ...
        if (!et1.getText().toString().isEmpty() &&
            ...
            precio = Double.parseDouble(et4.getText().toString());

            Intent i = new Intent();
            Bundle bundle = new Bundle();
            bundle.putInt(getString(R.string.tag_posicion), pos);
            ...
            bundle.putDouble(getString(R.string.tag_precio), precio);
            i.putExtras(bundle);
    ...
    private void getExtras(){
        ...
        if(b != null){
            ...
            precio = b.getDouble(getString(R.string.tag_precio));
            id = b.getInt(getString(R.string.tag_id));
            pos = b.getInt(getString(R.string.tag_posicion));
        }
